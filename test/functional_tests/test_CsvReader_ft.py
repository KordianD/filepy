...
def test_should_correctly_read_csv_without_column_labels():
    ...
    assert csv_reader._column_names == []

    assert csv_reader._data == [['Index', 'Girth (in)', 'Height (ft)', 'Volume (ft^3)'],
                                ['1', '8.3', '70', '10.3'],
                                ['2', '8.6', '65', '10.3'],
                                ['3', '8.8', '63', '10.2'],
                                ['4', '10.5', '72', '16.4'],
...
def test_should_correctly_read_csv_without_first_column():
    ...
    assert csv_reader._column_names == ['Girth (in)', 'Height (ft)', 'Volume (ft^3)']

    assert csv_reader._data == [['8.3', '70', '10.3'],
                                ['8.6', '65', '10.3'],
                                ['8.8', '63', '10.2'],
                                ['10.5', '72', '16.4'],
                                ['10.7', '81', '18.8']]
